...
def predict_sync_step(octo_coords):
    """Find the first step where all 100 octopods flash at once"""
    # Copy initial state instead of modifying
    state = [[i for i in line] for line in octo_coords]
...
if __name__ == '__main__':
    with open("puzzle_1_input.text", "r") as f:
        ...
        sync_step = predict_sync_step(octomap)
        print(f"All Octopods flash together at step: {sync_step}")
